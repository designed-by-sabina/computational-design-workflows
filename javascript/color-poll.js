<script type="module">
  ...
  function getContrastTextColor(color) {
    // Draw a 1x1 pixel of the color on a hidden canvas,
    // then read back its actual RGB values.
    ...
    // Standard perceived-brightness formula (0 = black, 255 = white)
  ...
  // --- 6. Live aggregation + bubble rendering ---
