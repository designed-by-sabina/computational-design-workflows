...
## Josef Albers — _Interaction of Color_

Josef Albers' **_Interaction of Color_** serves as the primary conceptual reference for this project.

Albers demonstrated that color perception is relational: a color can appear different depending on the colors surrounding it. Through exercises using overlapping shapes, contrasts, and color relationships, he encouraged experimentation rather than memorization of color theory.

This project adapts that principle into a digital interactive format, allowing users to actively explore color relationships through movement, transparency, and real-time interaction.
...
- saving discovered colors as a digital palette,
- adding three or more simultaneous color interactions,
- creating user-controlled color experiments,
- adding new Albers-inspired exercises,
- expanding the collection of interactive canvases.
